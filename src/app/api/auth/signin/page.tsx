      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-slate-800/50 backdrop-blur-md border border-slate-700 rounded-2xl p-8 shadow-xl">
          ...
          <button
            ...
            disabled={isLoading}
            className="w-full mb-6 flex items-center justify-center gap-3 px-4 py-3 bg-white hover:bg-gray-100 text-gray-900 rounded-xl font-medium transition-all disabled:opacity-50 disabled:cursor-not-allowed shadow-lg"
          >
          ...
          <div className="mt-6 bg-indigo-900/30 border border-indigo-500/30 p-4 rounded-xl">
            <p className="text-xs text-indigo-300">
              <strong>Demo Mode:</strong> Just enter your email to {isSignUp ? "sign up" : "sign in"}. No password required!
            </p>
          </div>
        </div>
